...
typedef struct list {
  ...
  /* Used by SWAM wasm mutator to track list size in O(1). When AFL_SWAM
     is not defined this field remains unused but is kept to ensure that
     list_t has a stable layout across all translation units. */
  s32       element_total_count;
