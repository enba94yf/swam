...
#ifdef AFL_MUTATIONS_DEFINE_GLOBALS

/* Global tables are defined exactly once in a dedicated TU (see
   src/afl-mutations.c). Other TUs only see the extern declarations below. */
...
#ifdef AFL_SWAM
s64 interesting_64[] = {INTERESTING_8, INTERESTING_16, INTERESTING_32,
                        INTERESTING_64};

s32 interesting_f32[] = {INTERESTING_F32};
s64 interesting_f64[] = {INTERESTING_F64};
#endif

#else

/* Refer to the global tables defined in src/afl-mutations.c (or in the main
   afl-fuzz binary when used from custom mutators). Keep the declarations in
   sync with include/afl-fuzz.h. */
...
#ifdef AFL_SWAM
extern s64
    interesting_64[INTERESTING_8_LEN + INTERESTING_16_LEN +
                   INTERESTING_32_LEN + INTERESTING_64_LEN];
extern s32 interesting_f32[INTERESTING_F32_LEN];
extern s64 interesting_f64[INTERESTING_F64_LEN];
#endif

#endif  /* AFL_MUTATIONS_DEFINE_GLOBALS */
...
u32 text_array[MUT_TXT_ARRAY_SIZE] = {
    MUT_FLIPBIT,
    MUT_FLIPBIT,
    MUT_FLIPBIT,
    MUT_FLIPBIT,
...
extern u32 text_array[MUT_TXT_ARRAY_SIZE];
...
extern u32 binary_array[MUT_BIN_ARRAY_SIZE];
extern u32 normal_splice_array[MUT_NORMAL_ARRAY_SIZE];
extern u32 full_splice_array[MUT_SPLICE_ARRAY_SIZE];
extern u32 mutation_strategy_exploration_text[MUT_STRATEGY_ARRAY_SIZE];
extern u32 mutation_strategy_exploration_binary[MUT_STRATEGY_ARRAY_SIZE];
extern u32 mutation_strategy_exploitation_text[MUT_STRATEGY_ARRAY_SIZE];
extern u32 mutation_strategy_exploitation_binary[MUT_STRATEGY_ARRAY_SIZE];

#endif  /* AFL_MUTATIONS_DEFINE_GLOBALS for mutation tables */
...
u32 afl_mutate(afl_state_t *afl, u8 *buf, u32 len, u32 steps,
...
#endif  /* AFL_MUTATIONS_DEFINE_GLOBALS for mutation functions */
